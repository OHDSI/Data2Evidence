...
To use data mapping, the API_KEY for specific AI models should be provided in .env or .env.local file.
...
- For calling model directly from AI model provider, use the model name, e.g. 'openai:gpt-4o'
