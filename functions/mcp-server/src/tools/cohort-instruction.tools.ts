    ...
    async ({ cohortDescription }) => {
      return createTextResponse(`
          ...
          Strictly follow to-do list below for creation of ATLAS cohort definition:
            ...
            2. Identify all the relevant phenotype IDs (around 3) from 1 that closely matches the cohort description and list them for user to choose.
            3. Fetch cohort definition template with proper (with confirmation from user) phenotype ID from 2 using tool **fetch_templates_for_cohort_generation**
