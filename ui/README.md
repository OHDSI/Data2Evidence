...
```bash
mv /usr/src/data/plugins/d2e-ui/resources /usr/src/data/plugins/d2e-ui/resources-backup
rm -rf /usr/src/data/plugins/d2e-ui/resources
cp -r /usr/src/local-resources /usr/src/data/plugins/d2e-ui/resources
```
