...
import { QueryFilterCardModel, QueryFilterEvent, QueryFilterChip, QueryFilterManager, FilterType } from '../models/QueryFilterModel'
...
const activeEntryTab = ref<'earliest' | 'all' | 'latest'>('all')
const activeExitTab = ref<'obs' | 'fixed' | 'drug'>('obs')
...
const primaryFilters = computed(() => filterManager.getPrimaryFilters())
...
const handleCriteriaSelected = (option: CriteriaOption, type: FilterType) => {
  ...
  <div class="query-filter-demo">
     ...
     <div class="query-filter-container">
      <div class="query-filter-container__section">
        <div class="query-filter-container__header">
          <h3 class="query-filter-container__section-title">Cohort Entry Events</h3>

          <div class="query-filter-tabs">
            <button
              class="query-filter-tabs__tab query-filter-tabs__tab--earliest"
              :class="{ active: activeEntryTab === 'earliest' }"
              @click="activeEntryTab = 'earliest'"
            >
              Earliest
            </button>
            <button
              class="query-filter-tabs__tab query-filter-tabs__tab--all"
              :class="{ active: activeEntryTab === 'all' }"
              @click="activeEntryTab = 'all'"
            >
              All
            </button>
            <button
              class="query-filter-tabs__tab query-filter-tabs__tab--latest"
              :class="{ active: activeEntryTab === 'latest' }"
              @click="activeEntryTab = 'latest'"
            >
              Latest
            </button>
          </div>
    ...
    <!-- COHORT EXIT -->
     <div class="query-filter-container">
      <div class="query-filter-container__section">
        <div class="query-filter-container__header">
          <h3 class="query-filter-container__section-title">Cohort Exit</h3>

          <div class="query-filter-tabs">
            <button
              class="query-filter-tabs__tab query-filter-tabs__tab--earliest"
              :class="{ active: activeExitTab === 'obs' }"
              @click="activeExitTab = 'obs'"
            >
              Continuous observation
            </button>
            <button
              class="query-filter-tabs__tab query-filter-tabs__tab--all"
              :class="{ active: activeExitTab === 'fixed' }"
              @click="activeExitTab = 'fixed'"
            >
              Fixed duration to inital event
            </button>
            <button
              class="query-filter-tabs__tab query-filter-tabs__tab--drug"
              :class="{ active: activeExitTab === 'drug' }"
              @click="activeExitTab = 'drug'"
            >
