...
app.get("/ui/sap/ui/core/messagebundle_en_GB.properties", (req, res) => {
  console.log(
    "Serving static file:",
    "/ui/sap/ui/core/messagebundle_en_GB.properties"
  );

  const mockResponse =
    mockData.GET__ui_sap_ui_core_messagebundle_en_GB_properties;
...
app.get("/ui/sap/ui/core/messagebundle_en.properties", (req, res) => {
  console.log(
    "Serving static file:",
    "/ui/sap/ui/core/messagebundle_en.properties"
  );
...
app.get("/ui/sap/m/messagebundle_en_GB.properties", (req, res) => {
  console.log(
    "Serving static file:",
    "/ui/sap/m/messagebundle_en_GB.properties"
  );
...
app.get("/ui/sap/ui/core/themes/sap_belize/library.css", (req, res) => {
  console.log(
    "Serving static file:",
    "/ui/sap/ui/core/themes/sap_belize/library.css"
  );

  const mockResponse =
    mockData.GET__ui_sap_ui_core_themes_sap_belize_library_css;
...
app.get("/ui/sap/m/themes/sap_belize/library.css", (req, res) => {
  console.log(
    "Serving static file:",
    "/ui/sap/m/themes/sap_belize/library.css"
  );
...
app.get(
  "/js/node_modules_d4l_web-components-library_dist_esm_d4l-button_2_entry_js.js",
  (req, res) => {
    console.log(
      "Serving static file:",
      "/js/node_modules_d4l_web-components-library_dist_esm_d4l-button_2_entry_js.js"
...
app.get("/analytics-svc/api/services/population/json/barchart", (req, res) => {
  ...
  const mockResponse =
    mockData.GET__analytics_svc_api_services_population_json_barchart;
  res.status(mockResponse.status).json(mockResponse.body);
});

// GET /analytics-svc/api/services/population/json/patientcount (API)
app.get(
  "/analytics-svc/api/services/population/json/patientcount",
  (req, res) => {
    console.log("Request query:", req.query);
    console.log("Request body:", req.body);

    const mockResponse =
      mockData.GET__analytics_svc_api_services_population_json_patientcount;
    res.status(mockResponse.status).json(mockResponse.body);
  }
);
...
app.listen(PORT, () => {
  ...
  console.log(
    "  ✅ GET /js/node_modules_d4l_web-components-library_dist_esm_d4l-button_2_entry_js.js"
  );
  console.log("  ✅ GET /analytics-svc/api/services/population/json/barchart");
  console.log(
    "  ✅ GET /analytics-svc/api/services/population/json/patientcount"
  );
  ...
  console.log(
    "  🔄 GET /d2e-webapi/cohortdefinition/1/generate/4f05abcf-36d6-4e88-a44d-ad1ee3a0b06e (placeholder)"
  );
