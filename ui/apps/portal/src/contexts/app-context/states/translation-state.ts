export const i18nDefault = {
  default: {
    ...
    DELETE_STUDY_DIALOG__WARNING_CHILDREN: "Warning: This dataset has {0} cache dataset{1}. Deleting this dataset will also delete all its cache datasets.",
    DELETE_STUDY_DIALOG__CONFIRM_INSTRUCTION: "This action cannot be undone. Please enter the dataset name to confirm deletion.",
