export const i18nDefault = {
  default: {
    ...
    STUDY_OVERVIEW__DOWNLOAD_STRATEGUS_ERROR: "Download failed: {0}",
    ...
    UI_PLUGIN_DEMO_NOTIFICATIONS: "Demo Notifications",
    UI_PLUGIN_DEMO_PROJECTS: "Demo Projects",
    UI_PLUGIN_DEMO_SETUP: "Demo setup",
    UI_PLUGIN_DEMO_TEAM: "Demo Team",
    UI_PLUGIN_LOGS: "Logs",
    UI_PLUGIN_ETL: "ETL",
