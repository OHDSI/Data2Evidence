...
KEYS=(LOGTO__D2E_APP__CLIENT_ID LOGTO__D2E_APP__CLIENT_SECRET LOGTO__D2E_DATA__CLIENT_ID LOGTO__D2E_DATA__CLIENT_SECRET LOGTO__D2E_SVC__CLIENT_ID LOGTO__D2E_SVC__CLIENT_SECRET LOGTO_API_M2M_CLIENT_ID LOGTO_API_M2M_CLIENT_SECRET)
for KEY in ${KEYS[@]}; do
	# echo KEY=$KEY
	[[ $KEY =~ ID ]] && LENGTH=21
