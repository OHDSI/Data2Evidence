...
LEFT OUTER JOIN "legacy.ots::Views.Vocabularies" AS "Vocabularies_$1" ON
	( "Vocabularies_$1"."ExternalID" = "Patient_Attr_$0"."Address.Country.CodeSystem" ) )
LEFT OUTER JOIN "legacy.ots::Views.Vocabularies" AS "Vocabularies_$2" ON
	( "Vocabularies_$2"."ExternalID" = "Patient_Attr_$0"."Gender.CodeSystem" ) )
LEFT OUTER JOIN "legacy.ots::Views.Vocabularies" AS "Vocabularies_$3" ON
	( "Vocabularies_$3"."ExternalID" = "Patient_Attr_$0"."MaritalStatus.CodeSystem" ) )
LEFT OUTER JOIN "legacy.ots::Views.Vocabularies" AS "Vocabularies_$4" ON
	( "Vocabularies_$4"."ExternalID" = "Patient_Attr_$0"."Nationality.CodeSystem" ) )
LEFT OUTER JOIN "legacy.ots::Views.Vocabularies" AS "Vocabularies_$5" ON
...
FROM
	( ( ( ( "legacy.collections.db.models::CollectionModel.Collection" AS "C_$0"
INNER JOIN "legacy.collections.db.models::CollectionModel.Item" AS "I_$1" ON
	( "C_$0"."Id" = "I_$1"."Collection.Id" ) )
INNER JOIN "legacy.collections.db.models::CollectionModel.CohortsStatusConfig" AS "S_$2" ON
	( "S_$2"."Id" = "I_$1"."Status.Id" ) )
INNER JOIN "legacy.cdw.db.models::DWViews.Patient" AS "P_$3" ON
	( "I_$1"."Id" = "P_$3"."PatientID" ) )
INNER JOIN "legacy.collections.db.models::CollectionModel.Participant" AS "U_$4" ON
...
INNER JOIN "legacy.collections.db.models::CollectionModel.Item" AS "I_$1" ON
	( "C_$0"."Id" = "I_$1"."Collection.Id" ) )
INNER JOIN "legacy.cdw.db.models::DWViews.Patient" AS "P_$2" ON
	( "I_$1"."Id" = "P_$2"."PatientID" ) )
INNER JOIN "legacy.collections.db.models::CollectionModel.Participant" AS "U_$3" ON
	( "U_$3"."Collection.Id" = "C_$0"."Id" ) )
WHERE
	( "U_$3"."HANAUserName" = SESSION_CONTEXT ('APPLICATIONUSER') );
