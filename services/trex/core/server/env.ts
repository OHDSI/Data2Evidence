...
export const env = {
    ...
    // PREFECT_DOCKER_VOLUMES: JSON.parse(`["alp_trex:/app/duckdb_data", "/home/runner/work/Data2Evidence/Data2Evidence/tmp/drivers/ngdbc-latest.jar:/app/inst/drivers/ngdbc-latest.jar"]`),
