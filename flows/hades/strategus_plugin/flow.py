...
if __name__ == "__main__":
    ...
    options = {
        ...
        "datasetId": "88a35008-c89e-4779-9155-6d8f2db8f6e1", 
        # "datasetId": "285476d3-330d-49a6-87cf-36c18e5458d2", 
        "schemaName": "demo_cdm" 
    }
    json_graph = {"edges":{"e1":{"source":"treatment_patterns_node_0"},"e2":{"source":"cohort_node_0","target":"treatment_patterns_node_0"},"e3":{"source":"cohort_node_1","target":"treatment_patterns_node_0"},"e4":{"source":"cohort_node_2","target":"treatment_patterns_node_0"}},"nodes":{"cohort_node_0":{"id":"1d749dd2-0a72-460e-92f0-b2a99dfa65a4","type":"cohort_node","cohorts":[{"cohortId":2,"cohortName":"Depression", "cohortType": "target"}]},"cohort_node_1":{"id":"a1ef0e24-0cea-413e-9be7-470931e55bd2","type":"cohort_node","cohorts":[{"cohortId": 3,"cohortName":"NewUsersBupropion", "cohortType": "event"}]},"cohort_node_2":{"id":"9f162813-4757-4297-a39c-e18a0b92a8a8","type":"cohort_node","cohorts":[{"cohortId":4,"cohortName":"NewUsersSSRI", "cohortType": "exit"}]},"treatment_patterns_node_0":{"id":"3e81d37b-be4c-4873-ac85-425f5a4a4b18","type":"treatment_patterns_node","ageWindow":10,"splitTime":30,"censorType":"minCellCount","minCellCount":5,"maxPathLength":5,"minEraDuration":0,"eraCollapseSize":30,"indexDateOffset":0,"filterTreatments":"First","combinationWindow":30,"includeTreatments":"startDate","splitEventCohorts":"","minPostCombinationDuration":30}}}
