...
CREATE TABLE episode_evidence (
  ...
  episode_evidence_property_is_evidence_of_episode_outcome integer,
  episode_evidence_property_is_evidence_of_treatment_start integer,
  episode_evidence_property_is_evidence_of_ongoing_treatment integer,
  episode_supporting_evidence_property_can_update_start_date_of_existing_episode integer,
  episode_negating_evidence_property_negates_all_evidences_timing integer,
  ...
  group_evidences_by_month_during_rollup integer,
  loop_through_dates_during_rollup integer,
...
CREATE TABLE pharm (
  ...
  date_updated timestamp,
  is_current integer,
  common_query_indication varchar(10000),
  graph_order integer,
