...
-- Drop versioning for COHORT & COHORT_DEFINITION TABLES
ALTER TABLE COHORT DROP SYSTEM VERSIONING;
ALTER TABLE COHORT_DEFINITION DROP SYSTEM VERSIONING;
DROP TABLE COHORT_HISTORY;
DROP TABLE COHORT_DEFINITION_HISTORY;
ALTER TABLE COHORT DROP PERIOD FOR SYSTEM_TIME;
ALTER TABLE COHORT_DEFINITION DROP PERIOD FOR SYSTEM_TIME;
ALTER TABLE COHORT DROP(SYSTEM_VALID_FROM,SYSTEM_VALID_UNTIL);
ALTER TABLE COHORT_DEFINITION DROP(SYSTEM_VALID_FROM,SYSTEM_VALID_UNTIL);
