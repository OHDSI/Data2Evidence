...
def execute_dqd(dqd_params: DqdParams, flow_run_id: str):
    ...
    with robjects.conversion.localconverter(robjects.default_converter):
        ...
        r_execute_dqd(
            ...
            cdmDatabaseSchema = f"{dqd_params.databaseCode}.{dqd_params.schemaName}",
            vocabDatabaseSchema = f"{dqd_params.databaseCode}.{dqd_params.vocabSchemaName}",
            resultsDatabaseSchema = dqd_params.resultsSchemaName,
            cdmSourceName = f"{dqd_params.databaseCode}.{dqd_params.schemaName}",
