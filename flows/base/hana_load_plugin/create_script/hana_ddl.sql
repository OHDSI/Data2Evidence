...
CREATE TABLE @cdmDatabaseSchema.visit_occurrence (
			...
			provider_id integer NULL,
			care_site_id integer NULL,
			visit_source_value nvarchar(50) NULL,
			visit_source_concept_id integer NULL,
			admitting_source_concept_id integer NULL,
			admitting_source_value nvarchar(50) NULL,
			discharge_to_concept_id integer NULL,
			discharge_to_source_value nvarchar(50) NULL,
...
CREATE TABLE @cdmDatabaseSchema.visit_detail (
			...
			provider_id integer NULL,
			care_site_id integer NULL,
			visit_detail_source_value nvarchar(50) NULL,
...
CREATE TABLE @cdmDatabaseSchema.condition_occurrence (
			...
			condition_source_value nvarchar(50) NULL,
...
CREATE TABLE @cdmDatabaseSchema.drug_exposure (
			...
			sig nvarchar(5000) NULL,
			route_concept_id integer NULL,
			lot_number nvarchar(50) NULL,
			provider_id integer NULL,
			visit_occurrence_id integer NULL,
			visit_detail_id integer NULL,
			drug_source_value nvarchar(50) NULL,
...
CREATE TABLE @cdmDatabaseSchema.procedure_occurrence (
			...
			visit_occurrence_id integer NULL,
			visit_detail_id integer NULL,
			procedure_source_value nvarchar(50) NULL,
...
CREATE TABLE @cdmDatabaseSchema.device_exposure (
			...
			unique_device_id nvarchar(50) NULL,
			quantity integer NULL,
			provider_id integer NULL,
			visit_occurrence_id integer NULL,
			visit_detail_id integer NULL,
			device_source_value nvarchar(50) NULL,
...
CREATE TABLE @cdmDatabaseSchema.measurement (
			...
			measurement_time nvarchar(10) NULL,
			...
			visit_occurrence_id integer NULL,
			visit_detail_id integer NULL,
			measurement_source_value nvarchar(50) NULL,
			measurement_source_concept_id integer NULL,
			unit_source_value nvarchar(50) NULL,
			value_source_value nvarchar(50) NULL );
--HINT DISTRIBUTE ON KEY (person_id);
CREATE TABLE @cdmDatabaseSchema.observation (
			...
			value_as_number NUMERIC NULL,
			value_as_string nvarchar(60) NULL,
			value_as_concept_id Integer NULL,
			...
			visit_occurrence_id integer NULL,
			visit_detail_id integer NULL,
			observation_source_value nvarchar(50) NULL,
			observation_source_concept_id integer NULL,
			unit_source_value nvarchar(50) NULL,
			qualifier_source_value nvarchar(50) NULL );
--HINT DISTRIBUTE ON KEY (person_id);
...
CREATE TABLE @cdmDatabaseSchema.note (
			...
			note_title nvarchar(250) NULL,
			note_text nvarchar(5000) NOT NULL,
			encoding_concept_id integer NOT NULL,
			language_concept_id integer NOT NULL,
			provider_id integer NULL,
			visit_occurrence_id integer NULL,
			visit_detail_id integer NULL,
			note_source_value nvarchar(50) NULL );
--HINT DISTRIBUTE ON RANDOM;
CREATE TABLE @cdmDatabaseSchema.note_nlp (
			note_nlp_id integer NOT NULL,
			note_id integer NOT NULL,
			section_concept_id integer NULL,
			snippet nvarchar(250) NULL,
			"offset" nvarchar(50) NULL,
			lexical_variant nvarchar(250) NOT NULL,
			note_nlp_concept_id integer NULL,
			note_nlp_source_concept_id integer NULL,
			nlp_system nvarchar(250) NULL,
			nlp_date date NOT NULL,
			nlp_datetime TIMESTAMP NULL,
			term_exists nvarchar(1) NULL,
...
CREATE TABLE @cdmDatabaseSchema.location (
			...
			location_source_value nvarchar(50) NULL );
--HINT DISTRIBUTE ON RANDOM;
...
CREATE TABLE @cdmDatabaseSchema.provider (
			...
			provider_source_value nvarchar(50) NULL,
			specialty_source_value nvarchar(50) NULL,
...
CREATE TABLE @cdmDatabaseSchema.payer_plan_period (
			...
			payer_source_value nvarchar(50) NULL,
			payer_source_concept_id integer NULL,
			plan_concept_id integer NULL,
			plan_source_value nvarchar(50) NULL,
			plan_source_concept_id integer NULL,
			sponsor_concept_id integer NULL,
			sponsor_source_value nvarchar(50) NULL,
			sponsor_source_concept_id integer NULL,
			family_source_value nvarchar(50) NULL,
...
CREATE TABLE @cdmDatabaseSchema.cost (
			...
			revenue_code_source_value nvarchar(50) NULL,
...
CREATE TABLE @cdmDatabaseSchema.metadata (
			...
			value_as_string nvarchar(250) NULL,
			value_as_concept_id integer NULL,
...
CREATE TABLE @cdmDatabaseSchema.cdm_source (
			...
			cdm_source_abbreviation nvarchar(25) NULL,
			cdm_holder nvarchar(255) NULL,
			source_description nvarchar(5000) NULL,
			source_documentation_reference nvarchar(255) NULL,
			cdm_etl_reference nvarchar(255) NULL,
			source_release_date date NULL,
			cdm_release_date date NULL,
			cdm_version nvarchar(10) NULL,
			vocabulary_version nvarchar(20) NULL );
--HINT DISTRIBUTE ON RANDOM;
...
CREATE TABLE @cdmDatabaseSchema.vocabulary (
			...
			vocabulary_reference nvarchar(255) NOT NULL,
...
CREATE TABLE @cdmDatabaseSchema.relationship (
			...
			defines_ancestry nvarchar(1) NOT NULL,
...
CREATE TABLE @cdmDatabaseSchema.source_to_concept_map (
			...
			source_code_description nvarchar(255) NULL,
			target_concept_id integer NOT NULL,
			target_vocabulary_id nvarchar(20) NOT NULL,
			valid_start_date date NOT NULL,
			valid_end_date date NOT NULL,
			invalid_reason nvarchar(1) NULL );
--HINT DISTRIBUTE ON RANDOM;
...
CREATE TABLE @cdmDatabaseSchema.cohort_definition (
			...
			cohort_definition_description nvarchar(5000) NULL,
			definition_type_concept_id integer NOT NULL,
			cohort_definition_syntax nvarchar(5000) NULL,
...
CREATE TABLE @cdmDatabaseSchema.attribute_definition (
			...
			attribute_description nvarchar(5000) NULL,
			attribute_type_concept_id integer NOT NULL,
			attribute_syntax nvarchar(5000) NULL );