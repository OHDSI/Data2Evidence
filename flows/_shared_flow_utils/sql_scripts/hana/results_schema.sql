...
CREATE TABLE ${RESULTS_SCHEMA}.cohort_censor_stats (cohort_definition_id int NOT NULL,
  lost_count BIGINT NOT NULL
);


CREATE TABLE ${RESULTS_SCHEMA}.cohort_inclusion (cohort_definition_id int NOT NULL,
...
CREATE TABLE ${RESULTS_SCHEMA}.cohort_inclusion_result (cohort_definition_id int NOT NULL,
...
CREATE TABLE ${RESULTS_SCHEMA}.cohort_inclusion_stats (cohort_definition_id int NOT NULL,
  rule_sequence int NOT NULL,
  mode_id int NOT NULL,
  person_count bigint NOT NULL,
...
CREATE TABLE ${RESULTS_SCHEMA}.cohort_summary_stats (cohort_definition_id int NOT NULL,
  mode_id int NOT NULL,
...
CREATE TABLE ${RESULTS_SCHEMA}.cohort_cache  (design_hash int NOT NULL,
	SUBJECT_ID bigint NOT NULL,
	cohort_start_date date NOT NULL,
	cohort_end_date date NOT NULL
);
...
CREATE TABLE ${RESULTS_SCHEMA}.cohort_censor_stats_cache  (design_hash int NOT NULL,
  lost_count BIGINT NOT NULL
);


CREATE TABLE ${RESULTS_SCHEMA}.cohort_inclusion_result_cache  (design_hash int NOT NULL,
  mode_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);
...
CREATE TABLE ${RESULTS_SCHEMA}.cohort_inclusion_stats_cache  (design_hash int NOT NULL,
  rule_sequence int NOT NULL,
  mode_id int NOT NULL,
  person_count bigint NOT NULL,
  gain_count bigint NOT NULL,
...
CREATE TABLE ${RESULTS_SCHEMA}.cohort_summary_stats_cache  (design_hash int NOT NULL,
  mode_id int NOT NULL,
  base_count bigint NOT NULL,
  final_count bigint NOT NULL
);
...
CREATE TABLE ${RESULTS_SCHEMA}.feas_study_inclusion_stats (study_id int NOT NULL,
  rule_sequence int NOT NULL,
...
CREATE TABLE ${RESULTS_SCHEMA}.feas_study_index_stats (study_id int NOT NULL,
  person_count bigint NOT NULL,
  match_count bigint NOT NULL
);


CREATE TABLE ${RESULTS_SCHEMA}.feas_study_result (study_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);
...
CREATE TABLE ${RESULTS_SCHEMA}.cohort_sample_element (cohort_sample_id int NOT NULL,
...
CREATE TABLE ${RESULTS_SCHEMA}.ir_analysis_dist  (analysis_id int NOT NULL,
...
CREATE TABLE ${RESULTS_SCHEMA}.ir_analysis_result (analysis_id int NOT NULL,
  target_id int NOT NULL,
  outcome_id int NOT NULL,
...
CREATE TABLE ${RESULTS_SCHEMA}.ir_analysis_strata_stats (analysis_id int NOT NULL,
  target_id int NOT NULL,
  outcome_id int NOT NULL,
...
CREATE TABLE ${RESULTS_SCHEMA}.ir_strata (analysis_id int NOT NULL,
  strata_sequence int NOT NULL,
  name varchar(255) NULL,
  description varchar(1000) NULL
);
...
CREATE LOCAL TEMPORARY TABLE ${RESULTS_SCHEMA}.#digits
 AS(
SELECT
digits.n  
FROM
...
CREATE LOCAL TEMPORARY TABLE ${RESULTS_SCHEMA}.#generate_dates
 AS(
SELECT
...
FROM
${RESULTS_SCHEMA}.#digits y1,
${RESULTS_SCHEMA}.#digits y10,
...
CREATE LOCAL TEMPORARY TABLE ${RESULTS_SCHEMA}.#yearly_dates
 AS(
SELECT
TO_DATE(d_years || '-' || d_months || '-' || 01, 'YYYY-MM-DD') as generated_date

FROM
${RESULTS_SCHEMA}.#generate_dates
where d_months = 1
);


CREATE LOCAL TEMPORARY TABLE ${RESULTS_SCHEMA}.#monthly_dates
 AS(
SELECT
TO_DATE(d_years || '-' || d_months || '-' || 01, 'YYYY-MM-DD') as generated_date
...
CREATE LOCAL TEMPORARY TABLE ${RESULTS_SCHEMA}.#weekly_dates
 AS(
SELECT
...
(
	...
	FROM ${RESULTS_SCHEMA}.#digits d1, ${RESULTS_SCHEMA}.#digits d10, ${RESULTS_SCHEMA}.#digits d100, ${RESULTS_SCHEMA}.#digits d1000
 ) seq);


CREATE LOCAL TEMPORARY TABLE ${RESULTS_SCHEMA}.#quarterly_dates
	 AS(
SELECT
...
-- monthly dates
CREATE LOCAL TEMPORARY TABLE ${RESULTS_SCHEMA}.#temp_period
 AS(
SELECT
*
...
FROM ${RESULTS_SCHEMA}.#monthly_dates md
...
FROM ${RESULTS_SCHEMA}.#weekly_dates wd
...
FROM ${RESULTS_SCHEMA}.#quarterly_dates qd
...
FROM ${RESULTS_SCHEMA}.#yearly_dates yd
...
from ${RESULTS_SCHEMA}.#temp_period;


truncate table ${RESULTS_SCHEMA}.#digits;

drop table ${RESULTS_SCHEMA}.#digits;


truncate table ${RESULTS_SCHEMA}.#generate_dates;

drop table ${RESULTS_SCHEMA}.#generate_dates;


truncate table ${RESULTS_SCHEMA}.#yearly_dates;

drop table ${RESULTS_SCHEMA}.#yearly_dates;


truncate table ${RESULTS_SCHEMA}.#quarterly_dates;

drop table ${RESULTS_SCHEMA}.#quarterly_dates;


truncate table ${RESULTS_SCHEMA}.#monthly_dates;

drop table ${RESULTS_SCHEMA}.#monthly_dates;


truncate table ${RESULTS_SCHEMA}.#weekly_dates;

drop table ${RESULTS_SCHEMA}.#weekly_dates;


TRUNCATE TABLE ${RESULTS_SCHEMA}.#temp_period;

DROP TABLE ${RESULTS_SCHEMA}.#temp_period;
