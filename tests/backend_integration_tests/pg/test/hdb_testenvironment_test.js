...
/**
 * Test suite for the PG test_environment.
 */
...
;(function () {
  ...
  var TestEnvironment = require('../lib/pg_testenvironment')
  ...
  describe('TESTENVIRONMENT TEST SUITE', function () {
    describe('TestEnvironment', function () {
      describe('constructor', function () {
        ...
        it('sets the internal pgClient to the passed argument', function () {
          testEnv = new TestEnvironment('fakeClient')
          expect(testEnv.pgClient).to.equal('fakeClient')
        })
      ...
      describe('envTeardown()', function () {
        ...
        it('shuts down the PG client', function (done) {
          testEnv.envTeardown(function () {
