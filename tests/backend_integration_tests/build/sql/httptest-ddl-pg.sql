...
from "HTTPTEST_SCHEMA"."ConfigDbModels_AssignmentDetail" as ad
...
select udc."User",
    ...
    c."Name",
    c."Data"
from "HTTPTEST_SCHEMA"."ConfigDbModels_UserDefaultConfig" as udc
...
select "Org_$0"."OrgID",
    ...
    "Org_$0"."ValidFrom",
    "Org_$0"."ValidTo"
from "HTTPTEST_SCHEMA"."legacy.cdw.db.models::Config.Org" as "Org_$0"
where (
...
select "Vocabularies_$0"."ID",
    "Vocabularies_$0"."ExternalID"
from "HTTPTEST_SCHEMA"."legacy.ots.internal::Entities.Vocabularies" as "Vocabularies_$0";
create view "HTTPTEST_SCHEMA"."legacy.cdw.db.models::DWViews.PatientTD" as
select "Patient_Attr_$0"."DWID" as "PatientID",
...
where ("Patient_Attr_$0"."DWDateTo" is null);
create view "HTTPTEST_SCHEMA"."legacy.cdw.db.models::DWViews.Patient" as
select "PatientTD_$0"."PatientID",
    ...
    "PatientTD_$0"."Fax",
    "PatientTD_$0"."Email"
from "HTTPTEST_SCHEMA"."legacy.cdw.db.models::DWViews.PatientTD" as "PatientTD_$0"
where (
        (
...
select "Condition_Attr_$0"."DWID" as "ConditionID",
...
from "HTTPTEST_SCHEMA"."legacy.cdw.db.models::DWEntities.Condition_Attr" as "Condition_Attr_$0"
...
where ("Condition_Attr_$0"."DWDateTo" is null);
create view "HTTPTEST_SCHEMA"."legacy.cdw.db.models::DWViewsEAV.Interaction_Details" as
select "Interaction_Details_$0"."DWID" as "InteractionID",
...
where ("Interaction_Details_$0"."DWDateTo" is null);
create view "HTTPTEST_SCHEMA"."legacy.ots::Views.Classification" as
select "Classification_$0"."VocabularyID",
...
from "HTTPTEST_SCHEMA"."legacy.ots.internal::Entities.Classification" as "Classification_$0";
create view "HTTPTEST_SCHEMA"."legacy.ots::Views.ConceptTerms" as
select "ConceptTerms_$0"."ConceptVocabularyID",
...
from "HTTPTEST_SCHEMA"."legacy.ots.internal::Entities.ConceptTerms" as "ConceptTerms_$0";
create view "HTTPTEST_SCHEMA"."legacy.cdw.db.models::DWViews.InteractionDetailsOTS" as
select "details_$0"."InteractionID" as "InteractionID",
...
select "Interactions_Attr_$0"."DWID" as "InteractionID",
    "Interactions_Key_Assoc"."InteractionID" as "SourceInteractionID",
    "Interactions_Key_Assoc"."DWSource" as "Source",
...
where ("Interactions_Attr_$0"."DWDateTo" is null);
create view "HTTPTEST_SCHEMA"."legacy.cdw.db.models::DWViews.Observations" as
select "Observations_Attr_$0"."DWID" as "ObsID",
...
select "Patient_Practitioner_Link_$0"."DWLinkID" as "ID",
...
select "Practitioner_Attr_$0"."DWID" as "PractitionerID",
    "Practitioner_Key_Assoc"."PractitionerID" as "SourcePractitionerID",
...
where ("Practitioner_Attr_$0"."DWDateTo" is null);
create view "HTTPTEST_SCHEMA"."legacy.cdw.db.models::DWViews.Practitioner" as
select "PractitionerTD_$0"."PractitionerID",
...
from "HTTPTEST_SCHEMA"."legacy.cdw.db.models::DWViews.PractitionerTD" as "PractitionerTD_$0"
where (
        (
...
select "Interaction_Measures_$0"."DWID" as "InteractionID",
    "Interactions_Key_Assoc"."InteractionID" as "SourceInteractionID",
    "Interactions_Key_Assoc"."DWSource" as "Source",
...
select "Interaction_Text_$0"."InteractionTextID",
...
from "HTTPTEST_SCHEMA"."legacy.cdw.db.models::DWViews.Interactions" as "Interactions_$0";
create view "HTTPTEST_SCHEMA"."legacy.cdw.db.models::InterfaceViews.GUARDED_PATIENT" as
select "Patient_$0"."PatientID" as "PATIENT_ID",
...
from "HTTPTEST_SCHEMA"."legacy.cdw.db.models::DWViews.Patient" as "Patient_$0";
create view "HTTPTEST_SCHEMA"."legacy.cdw.db.models::InterfaceViews.GUARDED_PATIENT_TD" as
select "PatientTD_$0"."PatientID" as "PATIENT_ID",
...
select "Interaction_Details_$0"."InteractionID" as "INTERACTION_ID",
...
from "HTTPTEST_SCHEMA"."legacy.cdw.db.models::DWViewsEAV.Interaction_Details" as "Interaction_Details_$0";
create view "HTTPTEST_SCHEMA"."legacy.cdw.db.models::InterfaceViews.INTERACTION_DETAILS_OTS" as
select "InteractionDetailsOTS_$0"."InteractionID" as "INTERACTION_ID",
...
from "HTTPTEST_SCHEMA"."legacy.cdw.db.models::DWViews.InteractionDetailsOTS" as "InteractionDetailsOTS_$0";
create view "HTTPTEST_SCHEMA"."legacy.cdw.db.models::InterfaceViews.INTERACTION_MEASURES_EAV" as
select "Interaction_Measures_$0"."InteractionID" as "INTERACTION_ID",
...
from "HTTPTEST_SCHEMA"."legacy.cdw.db.models::DWViewsEAV.Interaction_Measures" as "Interaction_Measures_$0";
create view "HTTPTEST_SCHEMA"."legacy.cdw.db.models::InterfaceViews.INTERACTION_TEXT_EAV" as
select "Interaction_Text_$0"."InteractionTextID" as "INTERACTION_TEXT_ID",
...
from "HTTPTEST_SCHEMA"."legacy.cdw.db.models::DWViewsEAV.Interaction_Text" as "Interaction_Text_$0";
create view "HTTPTEST_SCHEMA"."legacy.cdw.db.models::InterfaceViews.OBSERVATIONS" as
select "Observations_$0"."ObsID" as "OBS_ID",
...
from "HTTPTEST_SCHEMA"."legacy.cdw.db.models::DWViews.Observations" as "Observations_$0";
...
select "PractitionerTD_$0"."PractitionerID" as "PRACTITIONER_ID",
...
from "HTTPTEST_SCHEMA"."legacy.collections.db.models::CollectionModel.Comment" as "Comment_$0"
where ("Comment_$0"."Item.Id" = '');
...
from "HTTPTEST_SCHEMA"."legacy.collections.db.models::CollectionModel.Item" as "Item_$0";
...
group by "Item_$0"."Collection.Id";
create view "HTTPTEST_SCHEMA"."legacy.collections.db.models::CollectionModel.ItemIds" as
select COUNT ("Item_$0"."Id") as "ItemCount",
    "Item_$0"."Collection.Id" as "CollectionId"
from "HTTPTEST_SCHEMA"."legacy.collections.db.models::CollectionModel.Item" as "Item_$0"
group by "Item_$0"."Collection.Id";
create view "HTTPTEST_SCHEMA"."legacy.collections.db.models::CollectionModel.NoteIds" as
select COUNT ("AllCollectionComments_$0"."Id") as "NoteCount",
    "AllCollectionComments_$0"."CollectionId" as "CollectionId"
from "HTTPTEST_SCHEMA"."legacy.collections.db.models::CollectionModel.AllCollectionComments" as "AllCollectionComments_$0"
group by "AllCollectionComments_$0"."CollectionId";
create view "HTTPTEST_SCHEMA"."legacy.collections.db.models::CollectionModel.ParticipantIds" as
select COUNT ("Participant_$0"."HANAUserName") as "ParticipantCount",
    "Participant_$0"."Collection.Id" as "CollectionId"
from "HTTPTEST_SCHEMA"."legacy.collections.db.models::CollectionModel.Participant" as "Participant_$0"
group by "Participant_$0"."Collection.Id";
...
select "Participant_$0"."Collection.Id" as "CollectionId",
...
select "ParticipantPrivilege_$0"."Id",
    "ParticipantPrivilege_$0"."Title"
from "HTTPTEST_SCHEMA"."legacy.collections.db.models::CollectionModel.ParticipantPrivilege" as "ParticipantPrivilege_$0";
create view "HTTPTEST_SCHEMA"."legacy.collections.db.models::CollectionModel.CollectionItemsByStatus" as
select "Item_$0"."Collection.Id" as "CollectionId",
    "Item_$0"."Status.Id" as "StatusId",
    COUNT ("Item_$0"."Id") as "ItemCount"
from "HTTPTEST_SCHEMA"."legacy.collections.db.models::CollectionModel.Item" as "Item_$0"
group by "Item_$0"."Status.Id",
...
from "HTTPTEST_SCHEMA"."legacy.collections.db.models::CollectionModel.StatusConfiguration" as "StatusConfiguration_$0"
where (
...
select COUNT ("AllItemComments_$0"."Id") as "NoteCount",
    "AllItemComments_$0"."ItemId",
    "AllItemComments_$0"."CollectionId" as "CollectionId"
from "HTTPTEST_SCHEMA"."legacy.collections.db.models::CollectionModel.AllItemComments" as "AllItemComments_$0"
group by "AllItemComments_$0"."CollectionId",
    "AllItemComments_$0"."ItemId";
...
where ("Item_$0"."ItemType" = 'legacy.tax.Patient');
...
group by "StatusConfiguration_$0"."Id",
    "StatusConfiguration_$0"."TextKey",
    "Items"."Collection.Id";
...
from "HTTPTEST_SCHEMA"."legacy.config.db.models::Configuration.AssignmentDetail" as "AssignmentDetail_$0"
...
select "UserDefaultConfig_$0"."User",
    "UserDefaultConfig_$0"."ConfigType",
    "Config"."Id",
    "Config"."Version",
    "Config"."Name",
    "Config"."Data"
from "HTTPTEST_SCHEMA"."legacy.config.db.models::Configuration.UserDefaultConfig" as "UserDefaultConfig_$0"
...
from "HTTPTEST_SCHEMA"."legacy.di.db.model::DataIntegration.DISource" as "DISource_$0";
...
select "ConceptTranslation_$0"."TypeVocabularyID",
...
from "HTTPTEST_SCHEMA"."legacy.ots.internal::Entities.ConceptTranslation" as "ConceptTranslation_$0";
create or replace function "HTTPTEST_SCHEMA"."ConfigDbProcedures_GetAssignedConfigurations" (
...
from "HTTPTEST_SCHEMA"."ConfigDbModels_Assignment" as assignment
    join "HTTPTEST_SCHEMA"."ConfigDbModels_Config" as config on assignment."ConfigId" = config."Id"
...
$$;
create or replace function "HTTPTEST_SCHEMA"."ConfigDbProcedures_HasUserConfigurationAssigned" (
        USERNAME VARCHAR(128),
        CONFIG_ID VARCHAR(40),
        CONFIG_VERSION VARCHAR(20)
    ) returns table(ALLOWED INTEGER) language plpgsql as $$ begin return query
select case
        when count(*) > 0 then 1
        else 0
    end as ALLOWED
...
$$;
create or replace procedure "HTTPTEST_SCHEMA"."ConfigDbProcedures_DeleteAssignment" (
...
$$;
create OR replace procedure "HTTPTEST_SCHEMA"."ConfigDbProcedures_DeleteConfiguration" (
        IN CONF_ID varchar(40),
        IN CONF_VERSION varchar(20),
        IN CONF_STATUS varchar(20)
    ) language plpgsql AS $$
declare PREV_ROWCOUNT INTEGER default 0;
CUR_ROWCOUNT INTEGER default 1;
r record;
begin create temp table CONFIGS_TO_DELETE (
    CONFIG_ID varchar(40),
    CONFIG_VERSION varchar(20)
);
create temporary table ASSIGNMENTS_TO_DELETE (ASSIGNMENT_ID varchar(40));
insert into CONFIGS_TO_DELETE (CONFIG_ID, CONFIG_VERSION)
...
while CUR_ROWCOUNT > PREV_ROWCOUNT loop PREV_ROWCOUNT := CUR_ROWCOUNT;
insert into CONFIGS_TO_DELETE (CONFIG_ID, CONFIG_VERSION)
SELECT "Id" AS CONFIG_ID,
    "Version" AS CONFIG_VERSION
...
SELECT count(*) into CUR_ROWCOUNT
FROM CONFIGS_TO_DELETE;
END loop;
...
begin for r in
select *
from ASSIGNMENTS_TO_DELETE loop call "HTTPTEST_SCHEMA"."ConfigDbProcedures_DeleteAssignment"(r.ASSIGNMENT_ID);
end loop;
end;
end;
$$;
DROP TYPE IF EXISTS CREATE_ASSIGNMENT_CONFIG_TYPE CASCADE;
CREATE TYPE CREATE_ASSIGNMENT_CONFIG_TYPE AS (
    CONFIG_ID VARCHAR(40),
    CONFIG_VERSION VARCHAR(20),
    CONFIG_TYPE VARCHAR(20)
);
CREATE or replace PROCEDURE "HTTPTEST_SCHEMA"."legacy.config.db.procedures::CreateAssignment" (
...
DECLARE USERNAME VARCHAR(256) := 'TEST_USER';
r record;
BEGIN GUID := uuid_generate_v4()::character varying;
...
END;
$$;
CREATE or replace PROCEDURE "HTTPTEST_SCHEMA"."legacy.config.db.procedures::CreateConfiguration" (
...
BEGIN IF CONFIG_ID is NULL THEN CONFIG_ID_OUT = uuid_generate_v4()::character varying;
ELSE CONFIG_ID_OUT = CONFIG_ID;
END IF;
...
SET "Status" = COALESCE(CONFIG_STATUS, "Status"),
...
END;
$$;
CREATE or replace PROCEDURE "HTTPTEST_SCHEMA"."legacy.config.db.procedures::DeleteAssignment" (
        IN ASSIGNMENT_ID character varying(256)
    ) LANGUAGE plpgsql as $$ BEGIN
...
END;
$$;
CREATE or replace PROCEDURE "HTTPTEST_SCHEMA"."legacy.config.db.procedures::DeleteConfiguration" (
        IN CONFIG_ID character varying(40),
        IN CONFIG_VERSION character varying(20),
...
FROM "HTTPTEST_SCHEMA"."legacy.config.db.models::Configuration.Config" configs
    JOIN CONFIGS_TO_DELETE as toDelete ON configs."Parent.Id" = toDelete.CONFIG_ID
...
FROM "HTTPTEST_SCHEMA"."legacy.config.db.models::Configuration.AssignmentHeader" header
    JOIN "HTTPTEST_SCHEMA"."legacy.config.db.models::Configuration.AssignmentDetail" detail ON header."Id" = detail."Header.Id"
    JOIN CONFIGS_TO_DELETE as toDelete ON detail."Config.Id" = toDelete.CONFIG_ID
...
CREATE TYPE ORG_TYPE AS ("ORG_ID" character varying(1024));
CREATE or replace PROCEDURE "HTTPTEST_SCHEMA"."legacy.config.db.procedures::GetOrganizations" (
...
END;
$$;
DROP TYPE IF EXISTS GET_ASSIGNED_CONFIGURATIONS_CONFIG_TYPE CASCADE;
CREATE TYPE GET_ASSIGNED_CONFIGURATIONS_CONFIG_TYPE AS (
    ASSIGNMENT_ID VARCHAR(40),
...
CREATE or replace PROCEDURE "HTTPTEST_SCHEMA"."legacy.config.db.procedures::GetAssignedConfigurations" (
        IN CONFIG_TYPE VARCHAR(20),
        IN USERNAME character varying(256),
        OUT CONFIGS GET_ASSIGNED_CONFIGURATIONS_CONFIG_TYPE []
    ) LANGUAGE plpgsql as $$ BEGIN CALL "HTTPTEST_SCHEMA"."legacy.config.db.procedures::GetOrganizations"(USERNAME, orgs);
insert into entities
SELECT 'U' as ENTITY_TYPE,
    USERNAME as ENTITY_VALUE
FROM DUMMY
UNION
SELECT 'O',
    ORG_ID as ENTITY_VALUE
FROM orgs;
insert into CONFIGS
SELECT assignment."Id" as ASSIGNMENT_ID,
    assignment."Name" as ASSIGNMENT_NAME,
...
FROM entities as ent
    JOIN "HTTPTEST_SCHEMA"."legacy.config.db.models::Configuration.Assignment" as assignment ON assignment."EntityType" = ent.ENTITY_TYPE
    AND assignment."EntityValue" = ent.ENTITY_VALUE
    JOIN "HTTPTEST_SCHEMA"."legacy.config.db.models::Configuration.Config" as config ON assignment."ConfigId" = config."Id"
    AND assignment."ConfigVersion" = config."Version"
WHERE config."Type" = CONFIG_TYPE
    AND config."Id" is not null;
END;
$$;
DROP TYPE IF EXISTS GET_CONFIGURATION_CONFIG_TYPE CASCADE;
CREATE TYPE GET_CONFIGURATION_CONFIG_TYPE AS (
    CONFIG_ID character varying(40),
    CONFIG_VERSION character varying(20),
...
CREATE or replace PROCEDURE "HTTPTEST_SCHEMA"."legacy.config.db.procedures::GetConfiguration" (
        IN CONFIG_ID character varying(40),
        IN CONFIG_VERSION character varying(20),
        IN CONFIG_STATUS character varying(1),
...
END;
$$;
DROP TYPE IF EXISTS ALLOWED_TYPE CASCADE;
CREATE TYPE ALLOWED_TYPE AS (ALLOWED INTEGER);
CREATE or replace PROCEDURE "HTTPTEST_SCHEMA"."legacy.config.db.procedures::HasUserConfigurationAssigned" (
...
UNION
SELECT 'U' as ENTITY_TYPE,
    'DEFAULT_CONFIG_ASSIGNMENT' as ENTITY_VALUE
FROM DUMMY
UNION
SELECT 'O',
    ORG_ID as ENTITY_VALUE
...
END;
$$;
drop type if exists "HTTPTEST_SCHEMA"."legacy.ots.am::Types.Candidate" cascade;
create type "HTTPTEST_SCHEMA"."legacy.ots.am::Types.Candidate" as (
    "CandidateID" BIGINT,
    "ComponentID" INTEGER,
...
drop type if exists "HTTPTEST_SCHEMA"."legacy.ots.am::Types.Match" cascade;

create type "HTTPTEST_SCHEMA"."legacy.ots.am::Types.Match" as (
    "CandidateID" BIGINT,
    "ComponentID" INTEGER,
    "ComponentTermText" character varying(5000),
    "VocabularyID" character varying(100),
...
create or replace procedure "HTTPTEST_SCHEMA"."legacy.ots.am.lib::MatchCandidates"(
