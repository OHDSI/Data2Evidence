    ...
    const inithana_cmd = this.program
      ...
      .action(async () => {
        ...
        const envVariables = {
          ...
          PREFECT_DOCKER_VOLUMES_CUSTOM: JSON.stringify([`${this.PROJECT_NAME}_trex:/app/duckdb_data`,`${cwd}/tmp/drivers/ngdbc-latest.jar:/app/inst/drivers/ngdbc-latest.jar`])
        };
