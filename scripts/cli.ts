    ...
    const inithana_cmd = this.program
      ...
      .action(async () => {
        ...
        const envVariables = {
          ...
          PREFECT_DOCKER_VOLUMES_CUSTOM: '["alp_trex:/app/duckdb_data", "/home/runner/work/Data2Evidence/Data2Evidence/tmp/drivers/ngdbc-latest.jar:/app/inst/drivers/ngdbc-latest.jar"]'
        };
        const envContent = Object.entries(envVariables)
