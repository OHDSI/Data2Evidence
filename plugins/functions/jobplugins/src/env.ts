...
export const env = {
  ...
  FHIR_STRUCTURE_MAP_TEMPLATE_REPO_URL: _env.FHIR_STRUCTURE_MAP_TEMPLATE_REPO_URL,
  FHIR_STRUCTURE_MAP_TEMPLATE_REPO_BRANCH: _env.FHIR_STRUCTURE_MAP_TEMPLATE_REPO_BRANCH,
};
