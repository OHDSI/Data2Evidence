...
import { LinkedAccountRouter } from './LinkedAccountRouter'
...
class Routes {
  ...
  constructor(
    ...
    private readonly linkedAccountRouter: LinkedAccountRouter
  ) {
    ...
    this.router.use('/linked-account', this.linkedAccountRouter.router)
  }
}
