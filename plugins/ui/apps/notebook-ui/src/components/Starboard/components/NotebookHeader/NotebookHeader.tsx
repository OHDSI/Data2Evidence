...
import { api } from "../../../../api";
import { useFeedback, useTranslation, i18nKeys, useUser } from "../../../../contexts";
...
export const Header: FC<HeaderProps> = ({
  ...
  const { user } = useUser();
  const isNotUserNotebook = useMemo(() => user.idpUserId !== activeNotebook?.userId, [user.idpUserId, activeNotebook]);
  ...
  }, [activeNotebook, activeDatasetId, fetchNotebooks, setFeedback, getText]);
  ...
  }, [currentContent, activeNotebook, fetchNotebooks, updateActiveNotebook, setFeedback, isShared, activeDatasetId, getText]);
  ...
  const renameNotebookName = useCallback(
    ...
    [activeNotebook, fetchNotebooks, updateActiveNotebook, setFeedback, isShared, activeDatasetId, getText]
  );
