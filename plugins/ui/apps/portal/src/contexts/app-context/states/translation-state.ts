export const i18nDefault = {
  default: {
    ...
    CLEANUP_STRATEGUS_STUDY_DIALOG__CONFIRM_MESSAGE: 'Are you sure you want to cleanup the results of study "{0}"? This action cannot be undone.',
    ...
    DATASET_CARD__PHYSIONET_GRANTED_BADGE: "Access via PhysioNet",
    DATASET_CARD__PHYSIONET_GRANTED_TITLE: "Access granted via PhysioNet",
    DATASET_CARD__PHYSIONET_LOCKED_BADGE: "PhysioNet",
    DATASET_CARD__PHYSIONET_LOCKED_TITLE: "Requires PhysioNet credentialing",
    ...
    INFORMATION__PHYSIONET_HINT_BODY: "This dataset is mirrored from PhysioNet. To access it,",
    INFORMATION__PHYSIONET_HINT_LINK: "link your PhysioNet account",
    INFORMATION__PHYSIONET_HINT_TAIL: "on the Account page.",
    INFORMATION__PHYSIONET_HINT_TITLE: "PhysioNet credentialing required.",
