export const i18nDefault = {
  default: {
    ...
    ACTION_SELECTOR__CONVERT_TO_WEBAPI: "Convert to WebAPI source",
    ...
    CONVERT_TO_WEBAPI_DIALOG__TITLE: "Convert to WebAPI source",
    CONVERT_TO_WEBAPI_DIALOG__BODY: "This action will register the dataset as a WebAPI source and cannot be undone. Continue?",
    CONVERT_TO_WEBAPI_DIALOG__CANCEL: "Cancel",
    CONVERT_TO_WEBAPI_DIALOG__CONFIRM: "Yes, convert",
    CONVERT_TO_WEBAPI_DIALOG__SUCCESS: "Dataset converted to WebAPI source",
    CONVERT_TO_WEBAPI_DIALOG__ERROR: "Failed to convert dataset",
