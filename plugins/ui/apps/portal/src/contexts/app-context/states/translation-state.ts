export const i18nDefault = {
  default: {
    ...
    AI_ASSISTANT__TITLE: "D2E AI assistant",
    AI_ASSISTANT__GREETING: "Hi, how can I help you?",
    AI_ASSISTANT__INPUT_PLACEHOLDER: "Write something...",
    AI_ASSISTANT__SEND: "Send",
    AI_ASSISTANT__ADD_ATTACHMENT: "Add attachment",
    AI_ASSISTANT__CLOSE: "Close",
    AI_ASSISTANT__EXPAND: "Expand",
    AI_ASSISTANT__COLLAPSE: "Collapse",
    AI_ASSISTANT__MORE_OPTIONS: "More options",
    AI_ASSISTANT__NEW_CONVERSATION: "New conversation",
    AI_ASSISTANT__DOWNLOAD_HISTORY: "Download chat history",
    AI_ASSISTANT__TRANSCRIPT_TITLE: "D2E AI assistant conversation",
    AI_ASSISTANT__TRANSCRIPT_EXPORTED: "Exported {0}",
    AI_ASSISTANT__TRANSCRIPT_YOU: "You",
    AI_ASSISTANT__SUGGESTION_WHAT_CAN_DO: "What D2E AI can do?",
    AI_ASSISTANT__SUGGESTION_BUILD_COHORT: "Help me to build cohort",
    ...
    AI_ASSISTANT__TOOL_REQUEST: "Request",
    AI_ASSISTANT__TOOL_RESPONSE: "Response",
    AI_ASSISTANT__TOOL_ERROR: "Error",
    AI_ASSISTANT__TOOL_SHOW_DETAILS: "Show tool call details",
    AI_ASSISTANT__TOOL_HIDE_DETAILS: "Hide tool call details",
    AI_ASSISTANT__CONCEPTS_INTRO:
      "Here is the list of concepts I will include in the concept set I will create. Please review before confirming.",
    AI_ASSISTANT__CONCEPTS_SET_FALLBACK_NAME: "New concept set",
    AI_ASSISTANT__CONCEPT_REMOVE: "Remove {0} from the concept set",
    AI_ASSISTANT__CONCEPT_RESTORE: "Put {0} back in the concept set",
    AI_ASSISTANT__CONCEPTS_SELECTED_COUNT: "{0} of {1} concepts selected",
    AI_ASSISTANT__CONCEPTS_INCLUDED: "Confirmed with {0} of {1} concepts",
    AI_ASSISTANT__CONCEPTS_APPROVE: "Approve concept set",
    AI_ASSISTANT__CONCEPTS_REJECT: "None of these fit",
    AI_ASSISTANT__CONCEPTS_AWAITING_REVIEW: "Review the concepts above, then approve the set to continue.",
    AI_ASSISTANT__CONCEPT_SET_INCLUDE_BOTH: "Include both concept sets",
    AI_ASSISTANT__CONCEPT_SET_INCLUDE_ALL: "Include all {0} concept sets",
    AI_ASSISTANT__CONCEPT_SET_BOTH_CHIP: "Both",
    AI_ASSISTANT__CONCEPT_SET_ALL_CHIP: "All {0}",
    AI_ASSISTANT__CONCEPT_SET_USE_SELECTED: "Use selected ({0})",
    AI_ASSISTANT__CONCEPT_SET_REJECT: "Neither fits",
    AI_ASSISTANT__CONCEPT_SET_AWAITING_CHOICE: "Pick one of the concept sets above to continue.",
    ...
    FEATURE__ATLAS: "Atlas",
    FEATURE__PYTHIA: "Pythia (Atlas AI assistant)",
    ...
    STUDY_CARD__OPEN_VIEWER: "Open viewer",
    STUDY_CARD__RESULTS_VIEWER: "Results viewer - ",
