...
// SOURCE OF TRUTH: plugins/functions/d2e-webapi/src/utils/conceptSetRef.ts
// Keep this module in lockstep (behaviour, error messages, regex sources) with
// the backend. The Zod schemas in the backend are intentionally NOT mirrored
// here; this frontend mirror exposes the runtime parser/formatter/predicate
// surface only.
