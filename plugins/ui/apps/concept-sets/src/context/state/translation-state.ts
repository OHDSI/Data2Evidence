export const i18nDefault = {
  default: {
    ...
    TERMINOLOGY__SUGGESTED_CONCEPTS: "Suggested concepts",
    TERMINOLOGY__ALL_CONCEPTS: "All concepts",
    TERMINOLOGY__SUGGEST_CONCEPTS: "Suggest a concepts",
    TERMINOLOGY__SUGGEST: "Suggest",
    TERMINOLOGY__SOURCE: "Source",
    TERMINOLOGY__FREQUENCY: "Frequency",
    TERMINOLOGY__DESCRIPTION: "Description",
    ...
    TERMINOLOGY_LIST__RECORD_COUNT_TOOLTIP: "Record Count",
    TERMINOLOGY_LIST__DESCENDANT_RECORD_COUNT: "DRC",
    TERMINOLOGY_LIST__DESCENDANT_RECORD_COUNT_TOOLTIP: "Descendant Record Count",
