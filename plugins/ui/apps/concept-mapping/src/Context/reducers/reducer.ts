...
export enum ACTION_TYPES {
  ...
  UNCHECK_ROW = "UNCHECK_ROW",
  TOGGLE_ROW_FLAG = "TOGGLE_ROW_FLAG",
...
const actionMap = new Map<ActionType, ActionFunction>([
  ...
  [ACTION_TYPES.APPROVE_ROW, approveRow],
  [ACTION_TYPES.UNCHECK_ROW, uncheckRow],
  [ACTION_TYPES.TOGGLE_ROW_FLAG, toggleRowFlag],
