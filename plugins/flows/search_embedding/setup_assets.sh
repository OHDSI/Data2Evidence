...
# in pyproject.toml/pixi.lock. Runs as the pixi `setup-assets` task at
# provisioning time, cwd = plugin dir; flows resolve <cwd>/duckdb_extensions.
set -euo pipefail
DUCKDB_VERSION="1.4.0"
EXTENSIONS="postgres_scanner fts vss"
