...
CREATE INDEX IF NOT EXISTS HR_IDX_COHORT_ANALYSIS_CONCEPT ON ${DATA_CHARACTERIZATION_SCHEMA}.HERACLES_RESULTS (cohort_definition_id, analysis_id) WHERE stratum_2 <> '';
