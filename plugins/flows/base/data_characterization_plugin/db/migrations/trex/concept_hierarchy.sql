...
CREATE INDEX IF NOT EXISTS HRD_IDX_COHORT_DEF_ID ON ${DATA_CHARACTERIZATION_SCHEMA}.HERACLES_RESULTS_DIST (cohort_definition_id);

CREATE INDEX IF NOT EXISTS HRD_IDX_COHORT_ID_ANALYSIS_ID ON ${DATA_CHARACTERIZATION_SCHEMA}.HERACLES_RESULTS_DIST (cohort_definition_id, analysis_id);

CREATE INDEX IF NOT EXISTS HRD_IDX_COHORT_DEF_ID_DT ON ${DATA_CHARACTERIZATION_SCHEMA}.HERACLES_RESULTS_DIST (cohort_definition_id, last_update_time);

CREATE INDEX IF NOT EXISTS HRD_IDX_COHORT_ID_FIRST_RES ON ${DATA_CHARACTERIZATION_SCHEMA}.HERACLES_RESULTS_DIST (cohort_definition_id, analysis_id, count_value, stratum_1);

CREATE INDEX IF NOT EXISTS HR_IDX_COHORT_DEF_ID ON ${DATA_CHARACTERIZATION_SCHEMA}.HERACLES_RESULTS (cohort_definition_id);

CREATE INDEX IF NOT EXISTS HR_IDX_COHORT_ID_ANALYSIS_ID ON ${DATA_CHARACTERIZATION_SCHEMA}.HERACLES_RESULTS (cohort_definition_id, analysis_id);

CREATE INDEX IF NOT EXISTS HR_IDX_COHORT_ANALYSIS_CONCEPT ON ${DATA_CHARACTERIZATION_SCHEMA}.HERACLES_RESULTS (cohort_definition_id, analysis_id, stratum_2);

CREATE INDEX IF NOT EXISTS HR_IDX_COHORT_DEF_ID_DT ON ${DATA_CHARACTERIZATION_SCHEMA}.HERACLES_RESULTS (cohort_definition_id, last_update_time);

CREATE INDEX IF NOT EXISTS HR_IDX_COHORT_ID_FIRST_RES ON ${DATA_CHARACTERIZATION_SCHEMA}.HERACLES_RESULTS (cohort_definition_id, analysis_id, count_value, stratum_1);

CREATE INDEX IF NOT EXISTS HH_IDX_COHORT_ID_ANALYSIS_ID ON ${DATA_CHARACTERIZATION_SCHEMA}.HERACLES_HEEL_RESULTS (cohort_definition_id, analysis_id);

CREATE INDEX IF NOT EXISTS idx_heracles_periods_startdate ON ${DATA_CHARACTERIZATION_SCHEMA}.heracles_periods (period_start_date);

CREATE INDEX IF NOT EXISTS idx_heracles_periods_end_date ON ${DATA_CHARACTERIZATION_SCHEMA}.heracles_periods (period_end_date);

CREATE INDEX IF NOT EXISTS idx_cohort_sample_element_rank ON ${DATA_CHARACTERIZATION_SCHEMA}.cohort_sample_element (cohort_sample_id, rank_value);

CREATE INDEX IF NOT EXISTS idx_pathway_events_combo_id ON ${DATA_CHARACTERIZATION_SCHEMA}.pathway_analysis_events (combo_id);