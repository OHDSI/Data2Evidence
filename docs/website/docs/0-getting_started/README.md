...
```bash
.alp.local,registry-1.docker.io,localhost,::1,d2e-demodb,d2e-caddy,d2e-minerva-postgres-1,d2e-logto-1,d2e-logto-post-init-1,d2e-trex,d2e-supabase-storage-1,d2e-minerva-fhir-server-1,d2e-supabase-storage-post-init-1,d2e-dataflow-gen-1,d2e-dataflow-gen-worker
```
